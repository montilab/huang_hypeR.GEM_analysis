...
### non-directional
hypeR_GEM_obj <- readRDS(file = file.path(PATH, "data/EMT/hypR_object.rds"))
...
### directional
hypeR_GEM_obj_di <- readRDS(file = file.path(PATH, "data/EMT/hypR_object_di.rds"))
...
write.xlsx(res, file = file.path(PATH, "results/tables/EMT_summary_tables.xlsx"))
```
...
```{r}
hallmark_files <- list.files(file.path(PATH, "data/EMT/enrichment"), pattern = "hallmark\\.rds$", full.names = TRUE)
kegg_files <- list.files(file.path(PATH, "data/EMT/enrichment"), pattern = "kegg\\.rds$", full.names = TRUE)
reactome_files <- list.files(file.path(PATH, "data/EMT/enrichment"), pattern = "reactome\\.rds$", full.names = TRUE)
gobp_files <- list.files(file.path(PATH, "data/EMT/enrichment"), pattern = "gobp\\.rds$", full.names = TRUE)
gomf_files <- list.files(file.path(PATH, "data/EMT/enrichment"), pattern = "gomf\\.rds$", full.names = TRUE)
```
...
write.xlsx(GEM_enrichment_res, file = file.path(PATH, "results/tables/EMT_GEM_enrichment.xlsx"))
```
