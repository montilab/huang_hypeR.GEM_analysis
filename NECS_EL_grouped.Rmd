...
EL_cols <- c("CHEMICAL_NAME", "refmet_name",
             "offs.Estimate", "offs.Std.Error", "offs.p.value",
             "cent.Estimate", "cent.Std.Error", "cent.p.value",
             "cent.sigma2","offs.q.value", "cent.q.value",
             "SUPER_PATHWAY", "SUB_PATHWAY", "super_class", 
             "main_class", "sub_class")


met_sigs$EL <- met_sigs$EL %>% 
  dplyr::select(all_of(EL_cols))

max_fdr <- 0.05

met_sigs <- list(
  up = met_sigs$EL %>% dplyr::filter(cent.q.value <= max_fdr &  cent.Estimate > 0),
  dn = met_sigs$EL %>% dplyr::filter(cent.q.value <= max_fdr &  cent.Estimate < 0))
...
saveRDS(hypeR_GEM_obj, file = file.path(PATH, "data/NECS/EL_hypR_object.rds"))
```
...
saveRDS(hypeR_GEM_obj, file = file.path(PATH, "data/NECS/EL_hypR_object_di.rds"))
```
...
saveRDS(table_protein, file = file.path(PATH, "data/NECS/EL_table_protein.rds"))
saveRDS(table_protein_di, file = file.path(PATH, "data/NECS/EL_table_protein_di.rds"))
```
...
saveRDS(uu_hallmark, file = file.path(PATH, "data/NECS/enrichment/EL/uu_hallmark.rds"))
```
...
saveRDS(wu_hallmark, file = file.path(PATH, "data/NECS/enrichment/EL/wu_hallmark.rds"))
```
...
saveRDS(ud_hallmark, file = file.path(PATH, "data/NECS/enrichment/EL/ud_hallmark.rds"))
```
...
saveRDS(wd_hallmark, file = file.path(PATH, "data/NECS/enrichment/EL/wd_hallmark.rds"))
```
...
saveRDS(uu_kegg, file = file.path(PATH, "data/NECS/enrichment/EL/uu_kegg.rds"))
```
...
saveRDS(wu_kegg, file = file.path(PATH, "data/NECS/enrichment/EL/wu_kegg.rds"))
```
...
saveRDS(ud_kegg, file = file.path(PATH, "data/NECS/enrichment/EL/ud_kegg.rds"))
```
...
saveRDS(wd_kegg, file = file.path(PATH, "data/NECS/enrichment/EL/wd_kegg.rds"))
```
...
saveRDS(uu_reactome, file = file.path(PATH, "data/NECS/enrichment/EL/uu_reactome.rds"))
```
...
saveRDS(wu_reactome, file = file.path(PATH, "data/NECS/enrichment/EL/wu_reactome.rds"))
```
...
saveRDS(ud_reactome, file = file.path(PATH, "data/NECS/enrichment/EL/ud_reactome.rds"))
```
...
saveRDS(wd_reactome, file = file.path(PATH, "data/NECS/enrichment/EL/wd_reactome.rds"))
```
...
saveRDS(uu_gobp, file = file.path(PATH, "data/NECS/enrichment/EL/uu_gobp.rds"))
```
...
saveRDS(wu_gobp, file = file.path(PATH, "data/NECS/enrichment/EL/wu_gobp.rds"))
```
...
saveRDS(ud_gobp, file = file.path(PATH, "data/NECS/enrichment/EL/ud_gobp.rds"))
```
...
saveRDS(wd_gobp, file = file.path(PATH, "data/NECS/enrichment/EL/wd_gobp.rds"))
```
...
saveRDS(uu_gomf, file = file.path(PATH, "data/NECS/enrichment/EL/uu_gomf.rds"))
```
...
saveRDS(wu_gomf, file = file.path(PATH, "data/NECS/enrichment/EL/wu_gomf.rds"))
```
...
saveRDS(ud_gomf, file = file.path(PATH, "data/NECS/enrichment/EL/ud_gomf.rds"))
```
...
saveRDS(wd_gomf, file = file.path(PATH, "data/NECS/enrichment/EL/wd_gomf.rds"))
```
