---
title: "M005 Kidney summary table"
author: "Ziwei Huang"
...
### non-directional
hypeR_GEM_obj <- readRDS(file = file.path(PATH, "data/M005/kidney_hypR_GEM_object.rds"))
...
### Directional
hypeR_GEM_obj_di <- readRDS(file = file.path(PATH, "data/M005/kidney_hypR_GEM_object_di.rds"))
...
write.xlsx(res, file = file.path(PATH, "results/tables/M005_kidney_summary_tables.xlsx"))
```
...
```{r}
hallmark_files <- list.files(file.path(PATH, "data/M005/kidney_enrichment"), pattern = "hallmark\\.rds$", full.names = TRUE)
kegg_files <- list.files(file.path(PATH, "data/M005/kidney_enrichment"), pattern = "kegg\\.rds$", full.names = TRUE)
reactome_files <- list.files(file.path(PATH, "data/M005/kidney_enrichment"), pattern = "reactome\\.rds$", full.names = TRUE)
gobp_files <- list.files(file.path(PATH, "data/M005/kidney_enrichment"), pattern = "gobp\\.rds$", full.names = TRUE)
gomf_files <- list.files(file.path(PATH, "data/M005/kidney_enrichment"), pattern = "gomf\\.rds$", full.names = TRUE)
```
...
write.xlsx(GEM_enrichment_res, file = file.path(PATH, "results/tables/M005_kidney_GEM_enrichment.xlsx"))
```
