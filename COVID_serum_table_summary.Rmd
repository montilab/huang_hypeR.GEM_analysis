---
title: "COVID Serum Summary Tables"
author: "Ziwei Huang"
...
met_diffanal <- readRDS(file = file.path(PATH,"/data/External/COVID_serum_mets.rds")) %>% 
  do.call(rbind,.) %>% 
...
### non-directional
hypeR_GEM_obj <- readRDS(file = file.path(PATH, "data/External/serum_hypR_object.rds"))
...
### directional
hypeR_GEM_obj_di <- readRDS(file = file.path(PATH, "data/External/serum_hypR_object_di.rds"))
...
write.xlsx(res, file = file.path(PATH, "results/tables/COVID_serum_summary_tables.xlsx"))
```
...
```{r}
hallmark_files <- list.files(file.path(PATH, "data/External/enrichment/serum"), pattern = "hallmark\\.rds$", full.names = TRUE)
kegg_files <- list.files(file.path(PATH, "data/External/enrichment/serum"), pattern = "kegg\\.rds$", full.names = TRUE)
reactome_files <- list.files(file.path(PATH, "data/External/enrichment/serum"), pattern = "reactome\\.rds$", full.names = TRUE)
gobp_files <- list.files(file.path(PATH, "data/External/enrichment/serum"), pattern = "gobp\\.rds$", full.names = TRUE)
gomf_files <- list.files(file.path(PATH, "data/External/enrichment/serum"), pattern = "gomf\\.rds$", full.names = TRUE)
```
...
write.xlsx(GEM_enrichment_res, file = file.path(PATH, "results/tables/COVID_serum_GEM_enrichment.xlsx"))
```
