---
title: "M005 Kidney differential analysis using linear model"
author: "Ziwei Huang"
...
```{r}
## Metabolomics
SumExp_met <- readRDS(file = file.path(PATH, "data/M005/metabolomics/kidney_wmissing.rds"))
...
## Proteomics
SumExp_prot <- readRDS(file = file.path(PATH, "data/M005/proteomics/kidney_wmissing.rds"))
...
uniprot_mapping <- readRDS(file = file.path(PATH, "data/M005/proteomics/kidney_protein_uniprot_mapping.rds"))
```
...
```{r}
missing_threshold_met <- 0.7
missing_threshold_prot <- 0.7
...
if(run){
  ...
  saveRDS(met_diffanal, file = file.path(PATH, "data/M005/metabolomics/kidney_met_diffanal.rds"))
}else{
  met_diffanal <- readRDS(file = file.path(PATH, "data/M005/metabolomics/kidney_met_diffanal.rds"))
}
...
if(run){
  ...
  saveRDS(protein_diffanal, file = file.path(PATH, "data/M005/proteomics/kidney_protein_diffanal.rds"))
}else{
   protein_diffanal <- readRDS(file = file.path(PATH, "data/M005/proteomics/kidney_protein_diffanal.rds"))
}
...
saveRDS(hypeR_GEM_obj, file = file.path(PATH, "data/M005/kidney_hypR_GEM_object.rds"))
```
...
saveRDS(hypeR_GEM_obj_di, file = file.path(PATH, "data/M005/kidney_hypR_GEM_object_di.rds"))
```
...
saveRDS(table_protein, file = file.path(PATH, "data/M005/kidney_table_protein.rds"))
saveRDS(table_protein_di, file = file.path(PATH, "data/M005/kidney_table_protein_di.rds"))
```
...
saveRDS(uu_hallmark, file = file.path(PATH, "data/M005/kidney_enrichment/uu_hallmark.rds"))
```
...
saveRDS(wu_hallmark, file = file.path(PATH, "data/M005/kidney_enrichment/wu_hallmark.rds"))
```
...
saveRDS(ud_hallmark, file = file.path(PATH, "data/M005/kidney_enrichment/ud_hallmark.rds"))
```
...
saveRDS(wd_hallmark, file = file.path(PATH, "data/M005/kidney_enrichment/wd_hallmark.rds"))
```
...
saveRDS(uu_kegg, file = file.path(PATH, "data/M005/kidney_enrichment/uu_kegg.rds"))
```
...
saveRDS(wu_kegg, file = file.path(PATH, "data/M005/kidney_enrichment/wu_kegg.rds"))
```
...
saveRDS(ud_kegg, file = file.path(PATH, "data/M005/kidney_enrichment/ud_kegg.rds"))
```
...
saveRDS(wd_kegg, file = file.path(PATH, "data/M005/kidney_enrichment/wd_kegg.rds"))
```
...
saveRDS(uu_reactome, file = file.path(PATH, "data/M005/kidney_enrichment/uu_reactome.rds"))
```
...
saveRDS(wu_reactome, file = file.path(PATH, "data/M005/kidney_enrichment/wu_reactome.rds"))
```
...
saveRDS(ud_reactome, file = file.path(PATH, "data/M005/kidney_enrichment/ud_reactome.rds"))
```
...
saveRDS(wd_reactome, file = file.path(PATH, "data/M005/kidney_enrichment/wd_reactome.rds"))
```
...
saveRDS(uu_gobp, file = file.path(PATH, "data/M005/kidney_enrichment/uu_gobp.rds"))
```
...
saveRDS(wu_gobp, file = file.path(PATH, "data/M005/kidney_enrichment/wu_gobp.rds"))
```
...
saveRDS(ud_gobp, file = file.path(PATH, "data/M005/kidney_enrichment/ud_gobp.rds"))
```
...
saveRDS(wd_gobp, file = file.path(PATH, "data/M005/kidney_enrichment/wd_gobp.rds"))
```
...
saveRDS(uu_gomf, file = file.path(PATH, "data/M005/kidney_enrichment/uu_gomf.rds"))
```
...
saveRDS(wu_gomf, file = file.path(PATH, "data/M005/kidney_enrichment/wu_gomf.rds"))
```
...
saveRDS(ud_gomf, file = file.path(PATH, "data/M005/kidney_enrichment/ud_gomf.rds"))
```
...
saveRDS(wd_gomf, file = file.path(PATH, "data/M005/kidney_enrichment/wd_gomf.rds"))
```
...
saveRDS(hyp_metabolonSupPthwy, file = file.path(PATH, "data/M005/kidney_enrichment/Met_M_hyp_metabolonSupPthwy.rds"))
```
...
saveRDS(hyp_metabolonSubPthwy, file = file.path(PATH, "data/M005/kidney_enrichment/Met_M_hyp_metabolonSubPthwy.rds"))
```
...
saveRDS(hyp_refmetSuperClass, file = file.path(PATH, "data/M005/kidney_enrichment/Met_M_hyp_refmetSuperClass.rds"))
```
...
saveRDS(hyp_refmetMainClass, file = file.path(PATH, "data/M005/kidney_enrichment/Met_M_hyp_refmetMainClass.rds"))
```
...
saveRDS(hyp_refmetSubClass, file = file.path(PATH, "data/M005/kidney_enrichment/Met_M_hyp_refmetSubClass.rds"))
```
...
saveRDS(hyp_metabolon, file = file.path(PATH, "data/M005/kidney_enrichment/Met_R_hyp_metabolon.rds"))
```
...
saveRDS(hyp_refmet, file = file.path(PATH, "data/M005/kidney_enrichment/Met_R_hyp_refmet.rds"))
```
